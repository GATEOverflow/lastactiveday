    ...
    public function initialize()
    {
        ...
        if (qa_get_logged_in_userid()) {
            ...
            if (!isset($_COOKIE[$cookie_name]) || $_COOKIE[$cookie_name] !== $today) {				
				if(qa_db_activeday_try_claim_today($userid, Activeday_Constants::usermeta_title_ACTIVEDAYS, $today))
				{	
					qa_db_usermetas_increment($userid, Activeday_Constants::COLUMN_ACTIVEDAYS);
					...
					$points_counted="1";
					if($Availed_days>$max_days_to_be_availed)
						$points_counted="0";
					$params = [
